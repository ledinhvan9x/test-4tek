    ...
    >
      <div className="bg-[url(/assets/footer-background-mobile.png)] lg:bg-[url(/assets/footer-background.png)] flex flex-col lg:flex-row w-screen bg-no-repeat bg-cover lg:bg-center pt-10 pb-[50px] lg:pt-[100px] px-4 lg:px-10 xl:px-20 2xl:px-[230px] lg:pb-[92px]">
        <div className="flex flex-col lg:flex-row w-full justify-between">
          ...
          <div className="flex flex-col lg:flex-row gap-x-10 pt-[75px] lg:pt-0 md:items-center lg:items-start">
            <div className="flex flex-col">
              <p className="font-bold text-24 text-white-lightest">
                {t('address')}
              </p>
            ...
            <div className="flex flex-col max-w-[400px] mt-[70px] lg:mt-0 lg:pt-0">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-14 bg-transparent ring-transparent focus:ring-0 border border-white-lightest pl-4 hover:border-white-lightest placeholder:text-white-lightesttext-white-lightest"
                />
                <button
                  onClick={submitMail}
